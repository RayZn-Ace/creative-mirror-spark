...
Deno.serve(async () => {
  ...
  const baseUrl = "https://nightlifeticket.app";
  ...
  const staticPages = [
    ...
    { loc: "/vergangene-events", priority: "0.3", changefreq: "weekly" },
    { loc: "/abiklasse", priority: "0.4", changefreq: "monthly" },
    { loc: "/location-anmelden", priority: "0.4", changefreq: "monthly" },
  ];
