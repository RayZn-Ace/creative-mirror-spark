  ...
  <div className="min-h-screen" style={{ background: "hsl(0 5% 5%)" }}>
    ...
    <div className="pt-24 sm:pt-32 pb-16 sm:pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          {subtitle && (
            <p className="text-sm sm:text-base font-semibold uppercase tracking-wider mb-10" style={{ color: "hsl(0 70% 55%)" }}>
              {subtitle}
            </p>
          )}
    ...
    <footer className="pb-8 pt-8 border-t" style={{ borderColor: "hsl(0 0% 100% / 0.06)" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="text-xs" style={{ color: "hsl(0 0% 100% / 0.3)" }}>© 2025 Nachtaktiv Events</span>
