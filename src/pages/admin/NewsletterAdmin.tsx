...
const TEMPLATES: NewsletterTemplate[] = [
  ...
  },
  {
    ...
    description: "Mediterranes Flair & ABBA-Vibes",
    icon: Heart,
    ...
    blocks: () => [
      ...
      createBlock("spacer", { height: 16 }),
      createBlock("heading", { text: "Here we go again! 🇮🇹", level: 2, align: "center", color: "#1e3a5f" }),
      createBlock("text", { text: "Sing mit zu den größten Hits aller Zeiten!\nDancing Queen · Waterloo · Gimme! Gimme! Gimme!\nSOS · The Winner Takes It All", align: "center", color: "#555555" }),
      createBlock("spacer", { height: 8 }),
      createBlock("text", { text: "📅 Datum · 📍 Location\n🕐 Einlass ab XX:XX Uhr", align: "center", color: "#888888" }),
      createBlock("spacer", { height: 16 }),
      createBlock("button", { text: "🎟 Tickets sichern", url: "https://", bgColor: "#1e3a5f", textColor: "#c9a84c", align: "center", borderRadius: 50 }),
      createBlock("spacer", { height: 8 }),
  ...
  },
  {
    id: "mamma-mia-gold",
    name: "Mamma Mia Gold",
    description: "Glamourös & festlich",
    icon: Sparkles,
    ...
    blocks: () => [
      ...
      createBlock("spacer", { height: 16 }),
      createBlock("image", { src: "", alt: "Mamma Mia Show", width: 100 }),
      createBlock("spacer", { height: 16 }),
      createBlock("text", { text: "🎤 Live-Band · 🪩 Show-Programm · 🥂 VIP-Bereich", align: "center", bold: true, color: "#c9a84c" }),
      createBlock("spacer", { height: 8 }),
      createBlock("button", { text: "🌟 Jetzt dabei sein", url: "https://", bgColor: "#c9a84c", textColor: "#0d0d0d", align: "center", borderRadius: 8 }),
      createBlock("spacer", { height: 16 }),
  ...
  },
  {
    ...
    description: "Griechische Insel-Vibes",
    icon: Sun,
    ...
    blocks: () => [
      ...
      createBlock("spacer", { height: 16 }),
      createBlock("image", { src: "", alt: "Summer Vibes", width: 100 }),
      createBlock("spacer", { height: 8 }),
      createBlock("heading", { text: "Honey, Honey! 🍯", level: 2, align: "center", color: "#0ea5e9" }),
      createBlock("text", { text: "Hol dir dein Griechenland-Feeling!\n\n🌊 Open Air Atmosphäre\n🎶 ABBA Hits non-stop\n🍹 Cocktails & gute Laune", align: "center", color: "#555555" }),
      createBlock("spacer", { height: 16 }),
      createBlock("button", { text: "🏖 Tickets holen", url: "https://", bgColor: "#f97316", textColor: "#ffffff", align: "center", borderRadius: 50 }),
      createBlock("spacer", { height: 8 }),
