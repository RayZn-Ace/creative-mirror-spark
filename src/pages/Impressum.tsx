...
const sectionStyle = { color: "hsl(0 0% 100%)", fontFamily: "'Orbitron', sans-serif" };
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p>
          ...
          E-Mail: <a href="mailto:dennis@smea.info" className="text-primary hover:underline">dennis@smea.info</a>
        </p>
      </div>
