  ...
  <PageLayout title="Kontakt" subtitle="Wir sind für dich da">
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "hsl(0 70% 50% / 0.2)" }}>
            <Mail className="w-5 h-5" style={{ color: "hsl(0 70% 55%)" }} />
          </div>
          <div>
        ...
        >
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "hsl(142 70% 45% / 0.2)" }}>
            <MessageCircle className="w-5 h-5" style={{ color: "hsl(142 70% 55%)" }} />
          </div>
          <div>
            <div className="text-sm font-bold" style={{ color: "hsl(0 0% 100%)" }}>WhatsApp</div>
            <div className="text-xs" style={{ color: "hsl(0 0% 100% / 0.5)" }}>Schreib uns direkt</div>
          </div>
        </a>
        ...
        <a
          ...
          style={{ background: "hsl(0 0% 100% / 0.05)", border: "1px solid hsl(0 0% 100% / 0.08)" }}
        >
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)", opacity: 0.8 }}>
      ...
      <div className="p-6 rounded-2xl" style={{ background: "hsl(0 0% 100% / 0.03)", border: "1px solid hsl(0 0% 100% / 0.06)" }}>
        <h2 className="text-base font-bold uppercase mb-1" style={{ color: "hsl(0 0% 100%)", fontFamily: "'Orbitron', sans-serif" }}>
          Geschäftszeiten
        </h2>
